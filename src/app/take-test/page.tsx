  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="relative isolate px-6  lg:px-18">
        ...
        <div className="mt-32">
          <h1 className="text-4xl font-bold mb-4 text-center text-orange-500 tracking-tight text-balance font-inter ">
            Select Your Engineering Field
          </h1>
          <p className="text-center text-gray-600 mb-10">
            Choose your discipline to start practicing NEC license exam
            questions tailored for your engineering stream.
          </p>
        </div>
          ...
          {faculty.map((branch, idx) => (
            ...
            >
              <CardContent className="flex items-start gap-4 p-5">
                <div className="text-white bg-orange-500 rounded-md p-2">
                  {branch.icon}
                </div>
                <div>
                  ...
                  <p className="text-sm text-gray-600 font-poppins pt-2">
                    {branch.desc}
                  </p>
                </div>
              </CardContent>
